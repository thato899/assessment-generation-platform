...
- Issue #2 CAPS Grade 12 Physical Sciences curriculum metadata implemented on a feature branch.

## In progress
- Pull request for Issue #2 is ready for CI review.
...
## Test/CI status
Issue #1 PR #13 merged with CI quality and dependency-audit checks passing. Issue #2 local suite: 23 tests passed; 97% coverage; Ruff, mypy, and build passed. PR CI pending.
...
- Issue #2 pull request pending creation.
