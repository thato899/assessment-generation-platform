...
question belongs nowhere in this issue; conceptual treatment is deferred to
#60. Unsupported, underdetermined, inconsistent and numerical-range solver
...
rubrics, API integration, printing and final CAPS verification remain deferred
to #60-#62. Generation policy remains owned by #57 and numerical authority
remains owned by #56.
