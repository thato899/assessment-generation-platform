...
calculation questions are owned by #59 and conceptual templates are complete in
#60; API integration is active in #61 and final verification remains deferred to #62.
No new cross-cutting ADR is required for this renderer.
